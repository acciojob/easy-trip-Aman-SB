...
public class AirportController {
    ...
    public int getNumberOfPeopleOn(@PathVariable("date")@DateTimeFormat(pattern = "yyyy-MM-dd") Date date,@RequestParam("airportName")String airportName){
        ...
        int totat_num_of_people =  airportService.getNumberOfPeopleOn(date,airportName);
        return totat_num_of_people;
    }
    ...
    public int calculateFlightFare(@RequestParam("flightId")Integer flightId){
       ...
       int flight_fare = airportService.calculateFlightFare(flightId);
       return flight_fare;
    }
    ...
    public String bookATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        String output = airportService.bookATicket(flightId,passengerId);
    ...
    public String cancelATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        String cancel_output = airportService.cancelATicket(flightId,passengerId);
    ...
    public int countOfBookingsDoneByPassengerAllCombined(@PathVariable("passengerId")Integer passengerId){
        ...
        int total_count  = airportService.countOfBookingsDoneByPassengerAllCombined(passengerId);
       return total_count;
    }
    ...
    public String getAirportNameFromFlightId(@PathVariable("flightId")Integer flightId){
        ...
        String result = airportService.getAirportNameFromFlightId(flightId);
    ...
    public int calculateRevenueOfAFlight(@PathVariable("flightId")Integer flightId){
        ...
        int total_revenue = airportService.calculateRevenueOfAFlight(flightId);
